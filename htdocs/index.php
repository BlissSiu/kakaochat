...
<head>
	...
	<script>
		...
		function connect() {
			websocket = new WebSocket("ws://211.216.165.93:8008");
...
<body style="margin:0px">
	<div style="width:100%; display:inline-block; height:630px; padding:0px; margin:0px; position:relative; left:0px; top:0px"
		id="MAIN">
	...
	<div id="divAddMember"
		style="display:none; background-color:white; border:2px solid black; width:250px; padding:15px">
	</div>
	...
	<div id="divAddMemberTemplate" style="display:none">
		...
		<div style="text-align:center; margin-top:20px">
			<button
				style="background-color:yellow; border:0px; padding:10px; padding-top:5px; padding-bottom:5px; border:1px solid #eeeeee; border-radius:3px; font-weight:bold"
				onclick="addMemberComplete();">추가하기</button>
		</div>
	</div>
</body>
